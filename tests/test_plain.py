...
class TestPlain:
    ...
    def test_compute(self):
        ...
        compare([('d', ('d', 7, 8), ('d', 8))], diff.to_add)
        compare([('c', ('c', 5, 6), ('c', 6), ('c', 5, 7), ('c', 7))], diff.to_update)
        compare([('a', ('a', 1, 2), ('a', 2))], diff.to_delete)
    ...
    def test_duplicate_existing_key(self):
        ...
        diff = DiffTuple([('a', 1, 2), ('a', 3, 4), ('b', 1, 2), ('b', 3, 4)], [])
    ...
    def test_duplicate_imported_key_dealt_with(self):
        ...
        def handle_imported_problem(self, key, dups):
            ...
            return [(key, first_raw, (key, first_raw[1] + second_raw[1]))]
    ...
    def test_duplicate_imported_key_dealt_with_wrong(self):
        ...
        def handle_imported_problem(self, key, dups):
            return [(key, dups[0][0], dups[0][1]), (key, dups[1][0], dups[1][1])]
        ...
        with ShouldRaise(
            ValueError("Problem handling for 'a' resulted in duplicate key")
        ):
            diff.compute()
